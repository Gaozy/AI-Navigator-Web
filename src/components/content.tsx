        ...
        >
          <Box flexGrow={1} alignSelf="stretch" pt="100px">
            ...
            <VStack alignItems="flex-start" fontSize="16px">
              ...
              <Text>
                                Ilya 是 Afterwork 中的一个项目，想了解更多其他项目可以点击下方图片。
              </Text>
              <Link
              ...
              <Text>
                                项目地址：
                <a className="linkColor" href="https://github.com/afterwork-design/Ilya">Ilya | github</a>
              </Text>
              <Text>
                                资源推荐入口：
                <a className="linkColor" href="https://github.com/afterwork-design/Ilya/issues?q=label%3A%E8%B5%84%E6%BA%90%E6%8E%A8%E8%8D%90+">github 上提交 issue</a>
              </Text>
            </VStack>
          </Box>
